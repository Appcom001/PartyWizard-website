                ...
                <form class="w-full" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center justify-center gap-3 text-gray-500 mt-4">
                        <a href="{{ route('facebook.login') }}"
                            ...
                            <img src="{{ asset('assets/images/loginreg/Icon zocial-facebook.svg') }}"
                                alt="Facebook Icon" class="w-5 h-5">
                        </a>
                        <a href="{{ route('google.login') }}"
                            class="hover:bg-gray-100 duration-300 text-gray-500 border-custom-input rounded-xl w-1/3 py-3 flex items-center justify-center">
                            <img src="{{ asset('assets/images/loginreg/Icon awesome-google.svg') }}" alt="Google Icon"
                                class="w-5 h-5">
                        </a>
                        <a href="#"
                            class="hover:bg-gray-100 duration-300 text-gray-500 border-custom-input rounded-xl w-1/3 py-3 flex items-center justify-center">
                            <img src="{{ asset('assets/images/loginreg/Icon awesome-twitter.svg') }}"
