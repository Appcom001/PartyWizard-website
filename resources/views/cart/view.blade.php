    ...
    <main>
        <div class="sm:ml-64 mlcustom">
            <div class="px-4 pt-2.5 mt-3 flex items-start allmaindivs">
                    ...
                    <div class="titles flex items-center justify-between">
                        ...
                        <form action="{{ route('cart.clear') }}" method="POST">
                            ...
                            <button type="submit" class="text-sm text-gray-400 flex items-center gap-1 hover:text-gray-700">
                                <img class="w-3.5" src="{{ asset('assets/images/Icon feather-trash-2.svg') }}"
                                    alt="">
                                Remove all items
                            </button>
                        </form>
                                            ...
                                            <div class="flex items-center justify-between gap-2 space-y-0">
                                                ...
                                                <div class="w-full min-w-0 flex-1 max-w-md titleproh ms-3">
                                                    <span class="text-base text-sm text-gray-600 hover:underline">
                                                        {{ Str::limit($item->product->title, 25) }}
                                                ...
                                                <form action="{{ route('cart.update', $item->id) }}" method="POST"
                                                    class="flex items-center border border-gray-200 rounded-xl px-0.5">
                                                    @csrf
                                                    @method('PATCH')
                                                    <button type="submit" name="action" value="decrement"
                                                        class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-gray-200 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100">
                                                        <svg class="h-3 w-3 text-gray-900 font-bold" aria-hidden="true"
                                                    ...
                                                    <button type="submit" name="action" value="increment"
                                                        class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-gray-200 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100">
                                                        <svg class="h-2.5 w-2.5 text-gray-900 font-bold" aria-hidden="true"
                                                            xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 18 18">
                                                            <path stroke="currentColor" stroke-linecap="round"
                ...
                <!-- rightsec  -->
                <div class="rightsec h-auto ms-5 bg-white rounded-lg pt-5 shadow-sm p-4">
                    ...
                    <div class="flex items-start justify-center mt-10 mb-5">
