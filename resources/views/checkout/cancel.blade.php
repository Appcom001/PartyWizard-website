...
<head>
    ...
    <title>Payment Canceled - Party Wizard</title>
    ...
    <div class="container m-auto flex flex-col items-center justify-center">
        <div class="card p-6 max-w-xl w-full">
            <div class="card-body flex flex-col items-center justify-start gap-3">
                <img src="{{ asset('assets/images/cancel.svg') }}" alt="Payment Canceled" class="mb-3 w-56 md:w-28">

                <div class="w-full">

                    <div class="text-center mt-2 mb-4">
                        <p class="text-custom-orange mb-2 font-bold text-2xl">Payment Canceled!</p>
                        <p class="text-gray-500 text-lg">Your transaction was not completed. If you want to try again,
                            please return to the checkout page.</p>
                    </div>
